...
const serverRenderTemplatePath = resolve('./src/templates/index.server.html');
const serverRendererFilePath = resolve('./dist/server.html');

if (isProd) {
    // In production: create server renderer using template and built server bundle.
    // The server bundle is generated by vue-ssr-webpack-plugin.
    const template = fs.readFileSync(serverRendererFilePath, 'utf-8');
